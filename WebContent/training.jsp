								...
								<td width="170" valign="top" class="InnerPageBGColor">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											<td></td>
											<td>
												<a href="training.jsp" class="MainTitleMenuLink">Training</a>
											</td>
										</tr>
										<tr>
											<td height="5"></td>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											<td>
												...
												<span class="PaddingRight5px">></span>Training
											</td>
										</tr>
										<tr>
											<td height="3"></td>
													...
													<tr>
														...
														<td>
															<table width="100%" border="0" cellspacing="0"
																...
																<tr>
																	<td width="220" height="8" class="bold">
																		Practical Session / Theory Session 
																	</td>
																</tr>
																<tr>
																	<td width="220" height="8" class="">
																		Simulator/Emulator Practical Session.
																	</td>
																</tr>
																<tr>
																	<!--
