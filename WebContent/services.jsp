...
<td height="25" width="4" ></td>
  ...
  <tr>
    <td></td>
    <td><a href="services.jsp" class="MainTitleMenuLink">Our Services</a></td>
  </tr>
   <tr>
    <td height="5"></td>
    <td height="5"> </td>
  ...
  <tr>
    <td><a href="index.jsp" class="InnerPageNavLink">Home</a><span class="InnerPageNavLink"></span> <span class="PaddingRight5px">></span>Our Services</td>
  </tr>
  <tr>
    <td height="3"></td>
  </tr>
  <tr>
   ...
   <tr>
     <td class="InnerHeaderOrangeFontColor">Services</td>
   </tr>
   <tr>
    <td height="15"> </td>
  </tr>
     ...
     <td class="justify"><table width="100%" border="0" cellspacing="0" cellpadding="0">
         <tr>
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td width="220" height="8" class="MiddleContentHeader">Software Development</td>
                    </tr>
                  <tr>
                    <td width="220" height="5" class=""></td>
                    </tr>
                  <tr>
                    <td width="220" height="8" class="bold">POS Development</td>
                    </tr>
                    <tr>
                    <td width="220" height="8" class="bold">Java Development</td>
                    </tr>
                    <tr>
                    <td width="220" height="8" class="bold">Web Service API development</td>
                    </tr>
                    <tr>
                    <td width="220" height="8" class="bold">Payment Solution & Integrations</td>
                    </tr>
                    <tr>
                    <td width="220" height="8" class="bold">Android Apps Development</td>
                    </tr>                  
                    <tr>
                    <td width="220" height="8" class="bold">Mobile application development</td>
                    </tr>
                  <tr><!--
                    <td width="220" height="8" class="">50 Cragwood Road, Suite# 100,</td>
                    --></tr>                  
                  <tr><!--
                    <td width="220" height="8" class="">South Plainfield, NJ-07080,</td>
                    --></tr>                  
                  <tr>
              ...
              <tr>
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="175" class="MiddleContentHeader">Application Support</td>
                      <td width="10" class="MiddleContentHeader"></td>
                      <td class="MiddleContentHeader">&nbsp;</td>
                  </tr>
                  
                  <tr>
                    <td width="220" class="bold">POS Application Support & Maintenance</td>
                     
                  </tr>
                  <tr>
                    <td width="220" class="bold">Web Application Support & Maintenance</td>
                ...
                <td class=" "></td>
                  ...
                  <tr>
                    ...
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td height="8" class="MiddleContentHeader">Professional Training on</td>
                        </tr>                      
                      <tr>
                        <td width="220" height="8" class="bold">C++.</td>
                        </tr>                      
                      <tr>
                        <td width="220" height="8" class="bold">JAVA</td>
                        </tr>  
                         <tr>
                        <td width="220" height="8" class="bold">Andriod</td>
                        </tr> 
                         <tr>
                        <td width="220" height="8" class="bold">Web Service</td>
                        </tr>        
