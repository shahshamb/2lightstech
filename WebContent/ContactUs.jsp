								...
								<td width="170" valign="top" class="InnerPageBGColor">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											<td></td>
											<td>
												<a href="ContactUs.jsp" class="MainTitleMenuLink">Contact
													Us</a>
											</td>
										</tr>
										<tr>
										...
										<tr>
											<td></td>
											<td>
												<a href="enquiry.jsp" class="MainLeftMenuLink">Enquiry</a>
											</td>
										</tr>
										<tr class="InnerPageLeftMenuLine">
											<td height="1"></td>
  ...
  -->
								...
								<td width="" valign="top">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											<td>
												<img title="Contact Us" alt="2Lights Technologies Global"
										...
										<tr>
											<td>
												...
												<span class="PaddingRight5px">></span>Contact Us
											</td>
										</tr>
										<tr>
											<td height="3"></td>
													...
													<tr>
														...
														<td>
															<table width="100%" border="0" cellspacing="0"
																cellpadding="0">
																<tr>
																	<td width="100" class="justify"></td>
																</tr>
																<tr>
																	<td width="220" height="8" class="MiddleContentHeader">
																		Mail us on
																	</td>
																</tr>
																<tr>
													...
													<tr>
														...
														<td>
															<table width="100%" border="0" cellspacing="0"
																cellpadding="0">
																<!--<tr>
                    <td width="175" class="MiddleContentHeader">Contact Emails</td>
