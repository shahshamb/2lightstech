...
<!--   from 2lights Technologiesglobal.com/Contact.htm by HTTrack Website Copier/3.x [XR&CO'2013], Mon, 13 Jan 2014 07:05:34 GMT -->
<head>
...
<BODY class="center">
<table width="100%" border="0" cellspacing="0" cellpadding="0"  id="PageSize">
  <tr>
    <td></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="220" ><a href="Index-2.html"><img title="2lights Technologies Global Logo"  alt="2lights Technologies Global" src="Images/2lights TechnologiesGlobalLogo.jpg" border="0"/></a></td>
...
<td height="25" width="4" ></td>
  ...
  <tr>
    <td></td>
    <td><a href="java_dev.jsp" class="MainTitleMenuLink">Java Development</a></td>
  </tr>
   <tr>
    <td height="5"></td>
    <td height="5"> </td>
  ...
  <tr>
    <td><img title="Contact Us"  alt="2Lights Technologies Global" src="Images/contact.jpg" /></td>
  </tr>
  <tr>
    <td height="5"></td>
  </tr>
  <tr>
    <td><a href="index.jsp" class="InnerPageNavLink">Home</a><span class="InnerPageNavLink"></span> <span class="PaddingRight5px">></span>Java Web Development</td>
  </tr>
  <tr>
    <td height="3"></td>
  </tr>
  <tr>
   ...
   <tr>
     <td class="InnerHeaderOrangeFontColor">Java / Web Service Development</td>
   </tr>
   <tr>
    <td height="15"> </td>
  </tr>
   <tr>
     <td class="justify"><table width="100%" border="0" cellspacing="0" cellpadding="0">
         <tr>
                <td width="1" class=" "></td>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                  ...
                  <tr>
                    <td width="220" height="8" class="bold">Web based Application Development (Commercial/Non-Commercial) both.</td>
                    </tr>
                    <tr>
                    <td width="220" height="5" class=""></td>
                    </tr>
                     <tr>
                    <td width="220" height="8" class="bold">Java Web Services.</td>
                    </tr>
                    <tr>
                    <td width="220" height="5" class=""></td>
                    </tr>
                     <tr>
                    <td width="220" height="8" class="bold">Enterprise Development.</td>
                    </tr>
                    <tr>
                    <td width="220" height="5" class=""></td>
                    </tr>
                     <tr>
                    <td width="220" height="8" class="bold">Java API Development.</td>
                    </tr>
                    <tr>
                    <td width="220" height="5" class=""></td>
                    </tr>
                     <tr>
                    <td width="220" height="8" class="bold">Java Payment Integration.</td>
                    </tr>
                    <tr>
                    <td width="220" height="5" class=""></td>
                    </tr>
                     <tr>
                    <td width="220" height="8" class="bold">Java HTTP Services development.</td>
                    </tr>
                    <tr>
                    <td width="220" height="5" class=""></td>
                    </tr>
                  ...
                  <tr>
                    <td width="220" height="8" class="bold"></td>
                     <td width="1" class="">:</td>
                    <td class="bold"> </td>
                    
                    </tr> 
                    <tr>
                    <td width="175" class="MiddleContentHeader"></td>
                  ...
                  <tr>
                    <td width="220" height="8" class="">  </td>
                    </tr>  
                     <tr>
                    <td width="220" height="8" class="bold"> </td>
                     <td width="1" class="">:</td>
                    ...
                    <tr>
                    <td width="175" class="MiddleContentHeader">Ingenico</td>
                    ...
                    <tr>
                    <td width="175" class="MiddleContentHeader">PAX</td>
                    ...
                    <tr>
                    <td width="175" class="MiddleContentHeader">JustTide</td>
                    
                    <td width="10" class="">:</td>
                    <td class="">PC1000, M3000</td>
                  ...
                  --><tr>
                    <td width="220" height="10" class=""><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <!--<td width="22"><IMG type="image" src="Images/Phoneicon.gif" /></td>
                        <td> +1 908 769 1271</td>
                      --></tr>
                      <tr>
                        <!--<td><IMG type="image" src="Images/printicon.gif" /></td>
                        <td>+1 908 769 1272</td>
                      --></tr>
                    </table></td>
                    </tr>
                  <tr>
                    <td width="220" height="15" class="MiddleContentHeader"></td>
                    </tr>
					</table></td>
                <td width="1" class=""></td>
              </tr>
              <tr>
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="100%" class="">You can contact us for any kind of development for the above manufacturer models</td>
                      <td width="10" class="MiddleContentHeader"></td>
                      <td class="MiddleContentHeader">&nbsp;</td>
                  </tr>
                  
                  <tr>
                    <!--<td width="175" class="bold">Management consulting</td>
                    <td width="10" class="">:</td>
                    <td class="">itbusiness.consulting@gmail.com </td>
                  --></tr>
                  <tr>
                ...
                <td class=" "></td>
                  ...
                  <tr>
                    ...
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td height="20" class="MiddleContentHeader"> </td>
                        </tr>
                      <tr>
                        <!--<td height="8" class="MiddleContentHeader">India office</td>
                        --></tr>                      
                      <tr>
                        <!--<td width="220" height="8" class="bold">IT Business Consulting.</td>
                        --></tr>                      
                      <tr>
                        <!--<td width="220" height="8" class="">New Delhi,</td>
                        --></tr>                      
                      <tr><!--
                  ...
                  <tr><!--
                    <td height="8" class="MiddleContentHeader">Branch Offices</td>
                    --><td width="5"></td>
                    <td></td>
                    <td width="5"  class=""></td>
                    </tr>
                  ...
                  <tr><!--
                    <td height="8" class="bold">Patna</td>
                    --><td width="5"></td>
                      <td class="bold"> </td>
                      <td width="5"></td>
                      </tr>
                  ...
                  <tr>
                    <td height="10" class=""  valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <!--<td width="22"><IMG type="image" src="Images/Phoneicon.gif" /></td>
