...
<td height="25" width="4" ></td>
  ...
  <tr>
    <td></td>
    <td><a href="posDetail.jsp" class="MainTitleMenuLink">Point of Sale </a></td>
  </tr>
   <tr>
    <td height="5"></td>
    <td height="5"> </td>
  ...
  <tr>
    <td><a href="index.jsp" class="InnerPageNavLink">Home</a><span class="InnerPageNavLink"></span> <span class="PaddingRight5px">></span>POS Development Information</td>
  </tr>
  <tr>
    <td height="3"></td>
  </tr>
  <tr>
   ...
   <tr>
     <td class="InnerHeaderOrangeFontColor">POS Development on below Hardware</td>
   </tr>
   <tr>
    <td height="15"> </td>
  </tr>
     ...
     <td class="justify"><table width="100%" border="0" cellspacing="0" cellpadding="0">
         <tr>
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td width="220" height="8" class="MiddleContentHeader">Manufacturer and their Models.</td>
                    </tr>
                  <tr>
                    <td width="220" height="5" class=""></td>
                    </tr>
                  <tr>
                    <td width="220" height="8" class="bold">Manufacturer</td>
                     <td width="1" class="">:</td>
                    <td class="bold">Model </td>
                    
                    </tr> 
                    <tr>
                    <td width="175" class="MiddleContentHeader">Verifone</td>
                    
                    <td width="10" class="">:</td>
                    <td class="">V5, Vx510, Vx510G, Vx670, Nurit8320</td>
