...
public class SendSMS {
    ...
    {  
        final String USERNAME="9560453935";//REQUIRED
        final String PASSWORD="archies1983";//REQUIRED
        ...
        StringBuilder phoneNumber= new StringBuilder("9560453935");
        ...
        */
        ...
        for(String phNumber : arrPhoneNUmber)
        {
        	 sms.sendSMS(phNumber, textMessage, ACTION);
        }
        sms.logoutWay2SMS();
    }
}
